...
void convert(double axisAngle[4], double rotations[3])
{
    ...
    //std::cout<<"Norm AxisAngle: "<<axisAngle[0]<<axisAngle[1]<<axisAngle[2]<<std::endl;
...
void gainTuningForDefaultPIDVelocityControl()
{
  ...
  */
  ...
  double torsoPID[3] = {10,0,0};//{20,0,1.511};
  ...
  double hipPID[3] = {10,0,0};//{8.9705,0,0.0545};
